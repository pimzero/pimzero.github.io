...
You can skip to section [136 bytes - back to binutils] if you want the solution;
otherwise you will see the step by step progress leading to this solution.
...
![](assets/img/2020-04-19_18:50:46.png)
...
![](assets/img/2020-04-18_043804.png)
...
![](assets/img/2020-04-19_23:58:37.png)
...
`DT_SYMTAB` end with 15 bytes of `'\0'` (7 bytes because the tag is 5 or 6, and
...
$ stat -c "%s" elf_136.so
136
$ LD_PRELOAD=./elf_136.so ls
sh-5.0$
```

And now on the site:

![](assets/img/2020-04-19_23:16:33.png)
